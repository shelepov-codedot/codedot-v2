  ...
  <div class="text__wrapper">
    <div class="container container--text">
      <div class="text__inner">
        <p class="text__item">
          No matter what field you work in, if you found us, then you want to <b>
            increase the value of your products
          </b>
          and the satisfaction of your customers.
        </p>
        <p class="text__item">
          We are here to help your business find an
          <b>individual technical solution</b>. Our development team uses advanced technologies and
          approaches in various industries.
        </p>
      </div>
    </div>
  </div>
